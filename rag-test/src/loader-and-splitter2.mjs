...
//这里的retriever用不上，因为我们直接使用了 similaritySearchWithScore 来获取文档和相似度评分。retriever 是一个更高级的接口，适用于需要更多控制和定制化检索逻辑的场景，而 similaritySearchWithScore 则提供了一个简单直接的方法来获取文档和相似度评分。
