...
export type CreateDocumentAccessGrantsRequestDto =
  components['schemas']['CreateDocumentAccessGrantsRequest']
export type CreateDocumentAccessGrantsResponseDto =
...
export type DocumentAccessGrantUserDto =
  components['schemas']['DocumentAccessGrantUser']
