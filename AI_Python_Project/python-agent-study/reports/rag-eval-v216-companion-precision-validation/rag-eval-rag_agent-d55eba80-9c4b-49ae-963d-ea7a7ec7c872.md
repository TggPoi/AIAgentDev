...
- Run ID: `d55eba80-9c4b-49ae-963d-ea7a7ec7c872`
- Provider: `rag_agent`
- Status: `failed`
...
|---|---|---|---:|---:|---:|---|
| `reader_pdf_companion_ai_guard` | failed | `N/A` | no | N/A | 6698.47 | route_mismatch: Golden 要求普通 RAG，但实际未进入顶层 knowledge_retrieval 路径 |
