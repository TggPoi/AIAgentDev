...
- Run ID: `ff6f0c9b-3763-4d75-bf37-00fe38a42e21`
- Provider: `rag_agent`
- Status: `failed`
...
|---|---|---|---:|---:|---:|---|
| `reader_pdf_companion_ai_guard` | failed | `N/A` | no | N/A | 4635.18 | route_mismatch: Golden 要求普通 RAG，但实际未进入顶层 knowledge_retrieval 路径 |
