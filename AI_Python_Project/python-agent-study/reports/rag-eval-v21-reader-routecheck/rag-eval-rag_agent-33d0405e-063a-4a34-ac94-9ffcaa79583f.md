...
- Run ID: `33d0405e-063a-4a34-ac94-9ffcaa79583f`
- Provider: `rag_agent`
- Status: `partial`
...
|---|---|---|---:|---:|---:|---|
| `reader_ue5_perfect_block` | failed | `question_decomposition -> no_knowledge_retrieval` | no | 6 | 50136.67 | route_mismatch: Golden 要求普通 RAG，但实际未进入顶层 knowledge_retrieval 路径 |
| `reader_incremental_input_buffer` | evaluated | `simple_rag -> knowledge_retrieval` | yes | 6 | 43919.21 |  |
