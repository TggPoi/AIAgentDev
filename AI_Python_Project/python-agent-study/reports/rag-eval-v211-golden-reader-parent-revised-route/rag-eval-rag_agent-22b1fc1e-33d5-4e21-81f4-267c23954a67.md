...
- Run ID: `22b1fc1e-33d5-4e21-81f4-267c23954a67`
- Provider: `rag_agent`
- Status: `completed`
...
|---|---|---|---:|---:|---:|---|
| `reader_es_milvus_parent_child_expansion` | evaluated | `simple_rag -> knowledge_retrieval` | yes | 6 | 94821.91 |  |
