...
- Run ID: `f19538e7-292a-4330-ad54-75e1477aad36`
- Provider: `rag_agent`
- Status: `completed`
...
- Duration: 203223.85 ms

## 指标汇总

| Metric | Mean | Evaluated | Passed | Skipped | Errors | Baseline Δ |
|---|---:|---:|---:|---:|---:|---:|
| `retrieval_recall_at_k` | 0.7500 | 2 | 2 | 1 | 0 | N/A |
| `retrieval_precision_at_k` | 0.2000 | 2 | 0 | 1 | 0 | N/A |
| `retrieval_hit_rate_at_k` | 1.0000 | 2 | 2 | 1 | 0 | N/A |
| `retrieval_mrr` | 0.7500 | 2 | 2 | 1 | 0 | N/A |

## Case 明细

| Case | Status | Actual route | Retrieval | Knowledge version | Latency ms | Error |
|---|---|---|---:|---:|---:|---|
| `operator_pixel_sprite_rules` | evaluated | `simple_rag -> knowledge_retrieval` | yes | 6 | 77414.07 |  |
| `operator_art_visible_scope_multi` | evaluated | `simple_rag -> knowledge_retrieval` | yes | 6 | 44114.41 |  |
| `operator_dev_acl_negative` | evaluated | `simple_rag -> knowledge_retrieval` | yes | 6 | 81687.12 |  |
...
| `operator_art_visible_scope_multi` | `retrieval_recall_at_k` | evaluated | 0.5000 | true | score=0.5000 >= threshold=0.5000 |
| `operator_art_visible_scope_multi` | `retrieval_precision_at_k` | evaluated | 0.2000 | false | score=0.2000 < threshold=0.5000 |
| `operator_art_visible_scope_multi` | `retrieval_hit_rate_at_k` | evaluated | 1.0000 | true | score=1.0000 >= threshold=0.5000 |
| `operator_art_visible_scope_multi` | `retrieval_mrr` | evaluated | 0.5000 | true | score=0.5000 >= threshold=0.5000 |
