...
- Run ID: `fd27ef6c-6183-4c5d-b110-725cc29068f8`
- Provider: `rag_agent`
- Status: `failed`
...
|---|---|---|---:|---:|---:|---|
| `reader_pdf_nne_training_runtime` | failed | `question_decomposition -> no_knowledge_retrieval` | no | 0 | 79186.35 | route_mismatch: Golden 要求普通 RAG，但实际未进入顶层 knowledge_retrieval 路径 |
