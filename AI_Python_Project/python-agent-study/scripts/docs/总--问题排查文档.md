...
| [rag_graph_nodes.py (line 113)](D:/AI_Agent_Project/AI_Python_Project/python-agent-study/src/fast_app/graph/rag_graph_nodes.py:113) | 合理 | 节点级 trace 必须贴近节点，否则无法准确记录输入、输出和步骤边界 |
| [rag_agent_nodes.py (line 121)](D:/AI_Agent_Project/AI_Python_Project/python-agent-study/src/fast_app/graph/rag_agent_nodes.py:121) | 合理 | Agent step、tool、child run 的语义属于 Agent 节点本身        |
...
[rag_pipeline_service.py (line 548)](D:/AI_Agent_Project/AI_Python_Project/python-agent-study/src/fast_app/services/rag_pipeline_service.py:548) 和 [langgraph_rag_pipeline_service.py (line 98)](D:/AI_Agent_Project/AI_Python_Project/python-agent-study/src/fast_app/services/langgraph_rag_pipeline_service.py:98) 中的 `_langsmith_trace()`、`_langsmith_step_trace()` 基本只有 `pipeline_provider` 和名称不同。

[rag_agent_pipeline_service.py (line 171)](D:/AI_Agent_Project/AI_Python_Project/python-agent-study/src/fast_app/services/rag_agent_pipeline_service.py:171) 又重复了一次 root trace 组装。
...
[Prompt Guard (line 657)](D:/AI_Agent_Project/AI_Python_Project/python-agent-study/src/fast_app/services/prompt_guard_service.py:657) 和 Agent confirmation 都在重复填写：
...
- 完整读取文件：[knowledge_document_management_service.py (line 145)](D:/AI_Agent_Project/AI_Python_Project/python-agent-study/src/fast_app/services/knowledge_document_management_service.py:145)
- 完整正文放进 ToolMessage：[agent_task_executor.py (line 1369)](D:/AI_Agent_Project/AI_Python_Project/python-agent-study/src/fast_app/services/agent_task_executor.py:1369)
- 后续每轮携带全部历史消息：[agent_task_executor.py (line 1085)](D:/AI_Agent_Project/AI_Python_Project/python-agent-study/src/fast_app/services/agent_task_executor.py:1085)
...
[knowledge_document_management_service.py (line 469)](D:/AI_Agent_Project/AI_Python_Project/python-agent-study/src/fast_app/services/knowledge_document_management_service.py:469)
...
## ⚠️【待验收】问题十：拆分Planner的职责，引入Router模块负责决策：
...
[【任务2】独立语义 Router 与 Agent TaskPlan 路由改造](D:\AI_Agent_Project\AI_Python_Project\python-agent-study\scripts\docs\多轮上下文与Agent任务状态增强-实施验收.md)
...
[文档讲解](D:\AI_Agent_Project\AI_Python_Project\python-agent-study\scripts\docs\PPT，Excel，PDF文档处理实现方案 + 技术点讲解.md)

~~~cpp
//**PDF，Word 文件格式 处理还没实现**
~~~
